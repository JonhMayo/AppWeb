...
const API_URL = 'https://localhost:5000/profesores';
...
export const agregarCursoAProfesor = (profesorId, cursoId) => axios.post(`${API_URL}/profesores/agregar-curso`, { profesorId, cursoId });
export const eliminarCursoDeProfesor = (profesorId, cursoId) => axios.post(`${API_URL}/profesores/eliminar-curso`, { profesorId, cursoId });